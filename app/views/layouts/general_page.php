...
<html lang="en" dir="ltr">
  <head>
    ...
    <link href="<?=BASE?>assets/css/modern-dashboard.css" rel="stylesheet">
    <link href="<?=BASE?>assets/css/modern-utilities.css" rel="stylesheet">
    <link href="<?=BASE?>assets/css/responsive-fixes.css" rel="stylesheet">
    
    <!-- Custom Search Box Component -->
    <link href="<?=BASE?>assets/css/custom-search-box.css" rel="stylesheet">
