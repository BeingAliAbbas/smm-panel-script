...
$lang["Admin_Notification_Email"] = "Admin Notification Email";
$lang["Primary_email_for_admin_notifications_Leave_blank_to_use_admin_account_email"] = "Primary email address for receiving admin notifications. Leave blank to use the admin account email.";
$lang["Order_Notifications"] = "Order Notifications";
$lang["Email_admin_on_new_order"] = "Email Admin on New Order";
$lang["Send_email_to_admin_when_a_new_order_is_placed"] = "Send an email to the admin when a new order is placed";
$lang["Email_admin_on_order_error"] = "Email Admin on Order Error";
$lang["Send_email_to_admin_when_an_order_encounters_an_error"] = "Send an email to the admin when an order encounters an error";
$lang["Payment_Notifications"] = "Payment Notifications";
$lang["Email_admin_on_payment_submission"] = "Email Admin on Payment Submission";
$lang["Send_email_to_admin_when_a_user_submits_a_payment"] = "Send an email to the admin when a user submits a payment request";
$lang["Email_user_on_payment_approval"] = "Email User on Payment Approval";
$lang["Send_email_to_user_when_admin_approves_their_payment"] = "Send an email to the user when the admin approves their payment";
$lang["Provider_Balance_Monitoring"] = "Provider Balance Monitoring";
$lang["Email_admin_on_low_provider_balance"] = "Email Admin on Low Provider Balance";
$lang["Send_email_alert_when_provider_balance_falls_below_threshold"] = "Send an email alert when a provider's balance falls below the configured threshold";
$lang["Provider_Balance_Threshold"] = "Provider Balance Threshold";
$lang["Alert_will_be_sent_when_provider_balance_falls_below_this_value_Maximum_one_email_per_provider_per_24_hours"] = "An alert will be sent when a provider's balance falls below this value. Maximum one email per provider per 24 hours to prevent spam.";
$lang["Make_sure_SMTP_settings_are_configured_properly_in_the_SMTP_tab_for_emails_to_be_sent_successfully"] = "Make sure SMTP settings are configured properly in the SMTP Settings tab for emails to be sent successfully";
$lang["Send_Test_Email"] = "Send Test Email";
$lang["Sends_a_test_email_to_the_admin_notification_email_to_verify_configuration"] = "Sends a test email to the admin notification email address to verify the configuration";
$lang["Sending"] = "Sending...";
$lang["Failed_to_send_test_email"] = "Failed to send test email";
$lang["Test_email_sent_successfully_to"] = "Test email sent successfully to";
$lang["Failed_to_send_test_email_Check_SMTP_configuration"] = "Failed to send test email. Please check your SMTP configuration.";
$lang["Please_provide_an_admin_email_address"] = "Please provide an admin email address";
...
$lang["SMTP_password"] = "SMTP Password";
$lang["SMTP_encryption"] = "SMTP Encryption";
$lang["Sends_a_test_email_to_verify_SMTP_configuration"] = "Sends a test email to verify SMTP configuration";
$lang["Ticket_Notifications"] = "Ticket Notifications";
$lang["User_Registration_Notifications"] = "User Registration Notifications";
$lang["displays_account_activation_link"] = "Displays the account activation link";
