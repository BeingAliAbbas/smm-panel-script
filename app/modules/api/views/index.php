...
<?php if (get_code_part_by_position('api', 'top', '') != '') { ?>
<div class="col-sm-12">
  <div class="row">
    <div class="col-sm-12">
      <?=get_code_part_by_position('api', 'top', '')?>
    </div>
  </div>
</div>
<?php }?>
...
[
  ...
  <?php if (get_code_part_by_position('api', 'bottom', '') != '') { ?>
  <div class="col-sm-12">
    <div class="row">
      <div class="col-sm-12">
        <?=get_code_part_by_position('api', 'bottom', '')?>
      </div>
    </div>
  </div>
  <?php }?>
