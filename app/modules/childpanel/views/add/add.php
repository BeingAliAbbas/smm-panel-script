...
<<<<<<< HEAD
<?php if (get_code_part_by_position('child_panel', 'top', '') != '') { ?>
<div class="col-sm-12">
  <div class="row mb-4">
    <div class="col-sm-12">
      <?=get_code_part_by_position('child_panel', 'top', '')?>
    </div>
  </div>
</div>
<?php }?>
...
<?php if (get_code_part_by_position('child_panel', 'bottom', '') != '') { ?>
<div class="col-sm-12">
  <div class="row mb-4">
    <div class="col-sm-12">
      <?=get_code_part_by_position('child_panel', 'bottom', '')?>
    </div>
  </div>
</div>
<?php }?>
