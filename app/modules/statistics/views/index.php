...
<?php if (get_code_part_by_position('dashboard', 'top', '') != '') { ?>
<div class="col-sm-12">
  <div class="row">
    <div class="col-sm-12">
      <?=get_code_part_by_position('dashboard', 'top', '')?>
    </div>
  </div>
</div>
<?php }?>
...
<div class="row justify-content-center">
  ...
  <?php if (get_code_part_by_position('dashboard', 'bottom', '') != '') { ?>
  <div class="col-sm-12">
    <div class="row">
      <div class="col-sm-12">
        <?=get_code_part_by_position('dashboard', 'bottom', '')?>
      </div>
    </div>
  </div>
  <?php }?>
