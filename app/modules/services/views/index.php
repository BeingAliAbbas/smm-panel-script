...
<?php if (get_code_part_by_position('services', 'top', '') != '') { ?>
<div class="col-sm-12">
  <div class="row">
    <div class="col-sm-12">
      <?=get_code_part_by_position('services', 'top', '')?>
    </div>
  </div>
</div>
<?php }?>
...
<?php if (get_code_part_by_position('services', 'bottom', '') != '') { ?>
<div class="col-sm-12">
  <div class="row">
    <div class="col-sm-12">
      <?=get_code_part_by_position('services', 'bottom', '')?>
    </div>
  </div>
</div>
<?php }?>
