...
<<<<<<< HEAD
                ...
                <!-- New Transactional Email Notifications -->
                <div class="custom-controls-stacked">
                  <label class="form-check">
                    <input type="hidden" name="enable_email_new_order" value="0">
                    <input type="checkbox" class="form-check-input" name="enable_email_new_order" value="1" <?=(get_option('enable_email_new_order', '0') == '1') ? 'checked' : ''?>>
                    <span class="form-check-label"><?=lang("Email_admin_on_new_order")?> <small><?=lang("Send_email_to_admin_when_a_new_order_is_placed")?></small></span>
                  </label>
                </div>

                <div class="custom-controls-stacked">
                  <label class="form-check">
                    <input type="hidden" name="enable_email_order_error" value="0">
                    <input type="checkbox" class="form-check-input" name="enable_email_order_error" value="1" <?=(get_option('enable_email_order_error', '0') == '1') ? 'checked' : ''?>>
                    <span class="form-check-label"><?=lang("Email_admin_on_order_error")?> <small><?=lang("Send_email_to_admin_when_an_order_encounters_an_error")?></small></span>
                  </label>
                </div>

                <div class="custom-controls-stacked">
                  <label class="form-check">
                    <input type="hidden" name="enable_email_payment_submitted" value="0">
                    <input type="checkbox" class="form-check-input" name="enable_email_payment_submitted" value="1" <?=(get_option('enable_email_payment_submitted', '0') == '1') ? 'checked' : ''?>>
                    <span class="form-check-label"><?=lang("Email_admin_on_payment_submission")?> <small><?=lang("Send_email_to_admin_when_a_user_submits_a_payment")?></small></span>
                  </label>
                </div>

                <div class="custom-controls-stacked">
                  <label class="form-check">
                    <input type="hidden" name="enable_email_payment_approved" value="0">
                    <input type="checkbox" class="form-check-input" name="enable_email_payment_approved" value="1" <?=(get_option('enable_email_payment_approved', '0') == '1') ? 'checked' : ''?>>
                    <span class="form-check-label"><?=lang("Email_user_on_payment_approval")?> <small><?=lang("Send_email_to_user_when_admin_approves_their_payment")?></small></span>
                  </label>
                </div>

                <div class="custom-controls-stacked">
                  <label class="form-check">
                    <input type="hidden" name="enable_email_low_provider_balance" value="0">
                    <input type="checkbox" class="form-check-input" name="enable_email_low_provider_balance" value="1" <?=(get_option('enable_email_low_provider_balance', '0') == '1') ? 'checked' : ''?>>
                    <span class="form-check-label"><?=lang("Email_admin_on_low_provider_balance")?> <small><?=lang("Send_email_alert_when_provider_balance_falls_below_threshold")?></small></span>
                  </label>
                </div>
              ...
              <div class="form-group">
                <label class="form-label"><?=lang("Admin_Notification_Email")?></label>
                <input type="email" class="form-control" name="admin_notification_email" value="<?=get_option('admin_notification_email', '')?>">
                <small class="form-text text-muted"><?=lang("Primary_email_for_admin_notifications_Leave_blank_to_use_admin_account_email")?></small>
              </div>
