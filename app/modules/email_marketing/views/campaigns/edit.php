<div class="modal-header">
  <h4 class="modal-title"><i class="fe fe-edit"></i> Edit Campaign</h4>
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
</div>

<form class="actionForm" action="<?php echo cn($module . '/ajax_campaign_edit/' . $campaign->ids); ?>" method="POST">
  <div class="modal-body">
    
    <div class="form-group">
      <label>Campaign Name <span class="text-danger">*</span></label>
      <input type="text" class="form-control" name="name" value="<?php echo htmlspecialchars($campaign->name); ?>" placeholder="Enter campaign name" required>
    </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="number" class="form-control" name="sending_limit_hourly" value="<?php echo $campaign->sending_limit_hourly; ?>" placeholder="e.g., 100" min="1">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="number" class="form-control" name="sending_limit_daily" value="<?php echo $campaign->sending_limit_daily; ?>" placeholder="e.g., 1000" min="1">
    ...
    $.ajax({
      ...
      success: function(response){
        if(response.status == 'success'){
          ...
          $form.find('button[type="submit"]').prop('disabled', false).html('<i class="fe fe-save"></i> Update Campaign');
        }
      },
      error: function(){
