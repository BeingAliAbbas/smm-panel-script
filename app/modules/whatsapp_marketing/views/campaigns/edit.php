        ...
        <div class="modal-content">
            <form class="form actionForm" action="<?php echo cn('whatsapp_marketing/campaign_edit/' . $campaign->id) ?>" method="post" data-redirect="<?php echo cn('whatsapp_marketing/campaigns') ?>">
                <div class="modal-header bg-pantone">
                    <h4 class="modal-title text-white"><i class="fa fa-edit"></i> Edit WhatsApp Campaign</h4>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary round btn-min-width mr-1 mb-1">Update Campaign</button>
