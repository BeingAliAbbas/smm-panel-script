  ...
  <div class="modal-right">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <form class="form actionForm" action="<?php echo cn($module . '/ajax_api_config_create'); ?>" data-redirect="<?php echo cn($module . '/api_configs'); ?>" method="POST">
              ...
              <div class="row justify-content-md-center">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <small class="text-muted">A descriptive name for this API configuration</small>
                  </div>
                  
                  <div class="form-group">
                    <label>API Key <span class="text-danger">*</span></label>
                    <input type="text" class="form-control square" name="api_key" placeholder="YOUR_API_KEY" required>
                    <small class="text-muted">Your WhatsApp API key</small>
                  </div>
                  
                  <div class="form-group">
                    <label>API Endpoint <span class="text-danger">*</span></label>
                    <input type="url" class="form-control square" name="api_endpoint" value="http://waapi.beastsmm.pk/send-message" required>
                    <small class="text-muted">WhatsApp API endpoint URL</small>
                  </div>
