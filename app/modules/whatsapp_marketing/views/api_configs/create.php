        ...
        <div class="modal-content">
            <form class="form actionForm" action="<?php echo cn('whatsapp_marketing/api_config_create') ?>" method="post" data-redirect="<?php echo cn('whatsapp_marketing/api_configs') ?>">
                <div class="modal-header bg-pantone">
                    <h4 class="modal-title text-white"><i class="fa fa-cog"></i> Create API Configuration</h4>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary round btn-min-width mr-1 mb-1">Create Configuration</button>
