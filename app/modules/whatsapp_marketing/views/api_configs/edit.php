<form class="actionForm" action="<?php echo cn($module . '/ajax_api_config_edit/' . $config->ids); ?>" data-redirect="<?php echo cn($module . '/api_configs'); ?>" method="POST">
  ...
  <div class="modal-body">
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="name" value="<?php echo htmlspecialchars($config->name); ?>" required>
    </div>
    
    <div class="form-group">
      <label>API Key <span class="text-danger">*</span></label>
      <input type="text" class="form-control" name="api_key" value="<?php echo htmlspecialchars($config->api_key); ?>" required>
    </div>
    
    <div class="form-group">
      <label>API Endpoint <span class="text-danger">*</span></label>
      <input type="url" class="form-control" name="api_endpoint" value="<?php echo htmlspecialchars($config->api_endpoint); ?>" required>
    </div>
