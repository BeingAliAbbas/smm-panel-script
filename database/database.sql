...
--
-- Host: localhost:3306
-- Generation Time: Dec 24, 2025 at 03:04 PM
...
CREATE TABLE `code_parts` (
  ...
  `content` longtext DEFAULT NULL COMMENT 'HTML content for the page (used when content_mode is single)',
  `content_mode` varchar(20) NOT NULL DEFAULT 'single' COMMENT 'Content mode: single (same for all) or separate (different for mobile/desktop)',
  `content_mobile` longtext DEFAULT NULL COMMENT 'Mobile-specific HTML content (used when content_mode is separate)',
  `content_desktop` longtext DEFAULT NULL COMMENT 'Desktop-specific HTML content (used when content_mode is separate)',
...
CREATE TABLE `email_campaigns` (
  ...
  `spam_risk_emails` int(11) DEFAULT 0 COMMENT 'Emails marked as high spam risk',
  `validated_emails` int(11) NOT NULL DEFAULT 0,
  `invalid_emails` int(11) NOT NULL DEFAULT 0,
  `validation_skipped` int(11) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `email_deliverability_settings`
--
...
CREATE TABLE `email_logs` (
  ...
  `spam_risk_score` decimal(3,2) DEFAULT NULL COMMENT 'Spam risk score 0.00-1.00',
  `deliverability_status` enum('inbox','spam','bounced','unknown') DEFAULT 'unknown',
  `has_plain_text` tinyint(1) DEFAULT 0 COMMENT 'Has plain text alternative',
  `has_unsubscribe` tinyint(1) DEFAULT 0 COMMENT 'Has List-Unsubscribe header',
...
CREATE TABLE `email_recipients` (
  ...
  `status` enum('pending','sent','failed','opened','bounced','unsubscribed') NOT NULL DEFAULT 'pending',
  `validation_status` enum('pending','valid','invalid','skipped','error') DEFAULT 'pending',
  `validation_result` varchar(50) DEFAULT NULL COMMENT 'deliverable, undeliverable, risky, unknown',
  `validation_reason` varchar(100) DEFAULT NULL,
  `validation_score` decimal(3,2) DEFAULT NULL COMMENT '0.00 to 1.00 confidence score',
...
--
-- Table structure for table `email_unsubscribers`
--
...
CREATE TABLE `email_unsubscribers` (
  ...
  `source` varchar(100) DEFAULT NULL COMMENT 'Source of unsubscribe: campaign_id, manual, etc.',
  `campaign_id` int(11) DEFAULT NULL COMMENT 'Campaign ID if unsubscribed from campaign',
  `campaign_name` varchar(255) DEFAULT NULL COMMENT 'Campaign name for reference',
  `ip_address` varchar(45) DEFAULT NULL,
  `user_agent` text DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
...
--
-- Table structure for table `general_pay_url_logs`
--

CREATE TABLE `general_pay_url_logs` (
  `id` int(11) NOT NULL,
  `transaction_id` int(11) NOT NULL,
  `pay_token` varchar(64) NOT NULL,
  `access_ip` varchar(45) DEFAULT NULL COMMENT 'Supports both IPv4 and compressed IPv6 (max 39 chars)',
...
CREATE TABLE `general_transaction_logs` (
  ...
  `pay_token_used` tinyint(1) NOT NULL DEFAULT 0,
  `pay_token_used_at` datetime DEFAULT NULL,
  `pay_token_used_by_ip` varchar(45) DEFAULT NULL,
...
--
-- Table structure for table `general_user_notifications`
--
...
CREATE TABLE `sitemaps` (
  `id` int(11) NOT NULL,
  `filename` varchar(255) NOT NULL DEFAULT 'sitemap.xml',
  `content` longtext NOT NULL,
  `is_custom` tinyint(1) NOT NULL DEFAULT 0 COMMENT '1 for uploaded, 0 for auto-generated',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Stores sitemap files for SEO';
...
CREATE TABLE `whatsapp_config` (
  ...
  `messaging_enabled` tinyint(1) NOT NULL DEFAULT 1 COMMENT 'Global toggle to enable/disable WhatsApp messaging (1=enabled, 0=disabled)',
...
--
-- Indexes for table `email_deliverability_settings`
--
...
ALTER TABLE `email_logs`
  ...
  ADD KEY `idx_spam_risk` (`spam_risk_score`),
  ADD KEY `idx_deliverability` (`deliverability_status`);
...
--
-- Indexes for table `email_unsubscribers`
--
ALTER TABLE `email_unsubscribers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `ids` (`ids`),
...
--
-- Indexes for table `general_pay_url_logs`
--
ALTER TABLE `general_pay_url_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_transaction_id` (`transaction_id`),
  ADD KEY `idx_pay_token` (`pay_token`),
...
ALTER TABLE `general_transaction_logs`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_pay_token` (`pay_token`);
...
--
-- Indexes for table `general_user_notifications`
--
ALTER TABLE `general_user_notifications`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `email_deliverability_settings`
--
ALTER TABLE `email_deliverability_settings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `email_unsubscribers`
--
ALTER TABLE `email_unsubscribers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `general_pay_url_logs`
--
ALTER TABLE `general_pay_url_logs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `general_user_notifications`
--
ALTER TABLE `general_user_notifications`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
(155, 'cashmaal', 'Cashmaal', 5, 100, 0, 1, '{\"type\":\"cashmaal\",\"name\":\"Cashmaal\",\"min\":\"5\",\"max\":\"100\",\"new_users\":\"0\",\"status\":\"1\",\"option\":{\"tnx_fee\":\"0\",\"merchant_key\":\"\",\"rate_to_usd\":\"168\"}}');
